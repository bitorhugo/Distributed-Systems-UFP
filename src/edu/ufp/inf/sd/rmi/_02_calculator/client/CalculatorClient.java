...
import edu.ufp.inf.sd.rmi._02_calculator.server.RemoteArithmeticException;
...
public class CalculatorClient {
    ...
    private void playService() {
        try {
            ...
            var a = 2;
            var b = 2;
            var sum = this.calculatorRI.add(a, b);
            
            List<Double> myList = new ArrayList<Double>(List.of(1.0, 12.5));
            var sumList = this.calculatorRI.add(myList);

            var div = this.calculatorRI.div(a, b);
