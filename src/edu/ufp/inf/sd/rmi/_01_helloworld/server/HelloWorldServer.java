...
public class HelloWorldServer {
     ...
     */
    private HelloWorldRI stub;

    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            System.err.println("usage: java [options] edu.ufp.inf.sd._01_helloworld.server.HelloWorldServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
            //1. ============ Create Servant ============
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                this.stub = new HelloWorldImpl(); // since Impl extends UNICASTREMOTEOBJECT it is automatically exported
